...
int main(int argc, char **argv) {
    ...
    osgViewer::View* view1 = createView(50, 50, 320, 240, model1.get());
    osgViewer::View* view2 = createView(370, 50, 320, 240, model2.get());
    osgViewer::View* view3 = createView(185, 310, 320, 240, model3.get());
